...
=============================
1) Запуск сервера
Для запуска сервера достаточно открыть файл "start.bat". Он автоматически установит необходимые библиотеки, а также
запустит сервер. Для работы сервера окно консоли нужно не закрывать
